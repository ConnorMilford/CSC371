...
void printAll(struct Constituency constituencies[], int numConstituencies);
...
int main()
{
  ...
  printAll(copy, numConstituencies); 
...
void printAll(struct Constituency constituencies[], int numConstituencies) {
  ...
  for (int i = 0; i < numConstituencies; i++) {
    if (constituencies[i].numNeighbours > mostNeighbours.numNeighbours){
        mostNeighbours = constituencies[i];
    } else if (constituencies[i].numNeighbours < leastNeighbours.numNeighbours){
        leastNeighbours = constituencies[i];
    }
